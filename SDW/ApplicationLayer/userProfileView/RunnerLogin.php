...
<body>
    ...
    <div class="splogin">
        <form class="spform " method="POST">
            <h2 class="display-4">Runner Sign In</h2>
            <div class="form-group row">
                <label class="col-3 col-form-label">Username</label>
                <div class="col-8">
                    <input type="text" name="rusername" class="form-control" placeholder="Runner username">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="col-9">
                    <a data-toggle="modal" data-target="#spregisterModal" class="spreg"><small>Click here if you don't
                            have an account</small></a><br />
                    <a style="color:black" href="./CusLogin.php"><small>Click here if you are customer</small></a><br />
                    <a style="color:black" href="./SPLogin.php"><small>Click here if you are Service
                            Providerr</small></a><br />
                </div>
                <div class="col-3">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="rname" placeholder="Runner Full Name">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="rdriveno"
                                placeholder="Runner's Driving License Number">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="rtelno" placeholder="Contact Number">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="rusername" placeholder="Username">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="custom-file form-control">
                                <input type="file" class="custom-file-input" name="rfiles" id="rfiles" required />
                                <label class="custom-file-label">Driving License Number</label>
                            </div>
                        </div>
                    </div>
